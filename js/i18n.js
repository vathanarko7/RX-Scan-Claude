(function() {
  ...
  const dictionaries = {
    ...
    km: {
      ...
      'inventory.quick.expired': 'ផុតកំណត់',
      'inventory.quick.expiring': 'ជិតផុតកំណត់',
      ...
      'dashboard.greeting.evening': 'សួស្តីល្ងាច',
      'dashboard.attention.noun.single': 'ថ្នាំ',
      'dashboard.attention.noun.plural': 'ថ្នាំ',
      'dashboard.attention.summary': 'មាន {{count}} {{noun}} ត្រូវការការយកចិត្តទុកដាក់',
      ...
      'alerts.filter.low': 'ទាប',
      'alerts.filter.out': 'អស់',
      ...
      'analytics.chart.categoryMix.meta': 'ចំនួនថ្នាំ',
      ...
      'analytics.health.meta': '{{healthy}} នៃ {{total}} ថ្នាំលើសចំណុចបញ្ជាទិញបន្ថែម',
